 ...
 *******************************************************************************/
package fr.obeo.playground.restfulemf.sample.slider;
...
public class SliderComponent implements IComponent {
    ...
    public Element render() {
        ...
        // @formatter:off
        fr.obeo.playground.restfulemf.sample.slider.SliderElementProps.Builder sliderElementPropsBuilder = SliderElementProps.newSliderElementProps(id)
                .label(label)
                .minValue(minValue)
                .maxValue(maxValue)

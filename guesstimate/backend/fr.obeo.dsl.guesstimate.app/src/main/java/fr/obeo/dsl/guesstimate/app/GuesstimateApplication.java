 ...
 *******************************************************************************/
package fr.obeo.dsl.guesstimate.app;

import fr.obeo.dsl.guesstimate.configuration.GuesstimateConfiguration;
...
@Import(GuesstimateConfiguration.class)
public class GuesstimateApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(GuesstimateApplication.class, args);
    }
}

 ...
 *   <li>{@link fr.obeo.dsl.guesstimate.NormalDistribution#getSd <em>Sd</em>}</li>
 * </ul>
 *
...
public interface NormalDistribution extends DistributionSetting {
	 ...
	 * @see #setSd(double)
	 * @see fr.obeo.dsl.guesstimate.GuesstimatePackage#getNormalDistribution_Sd()
	 * @model default="1"
	 * @generated
	 */
	double getSd();
	...
	/**
	 * Sets the value of the '{@link fr.obeo.dsl.guesstimate.NormalDistribution#getSd <em>Sd</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

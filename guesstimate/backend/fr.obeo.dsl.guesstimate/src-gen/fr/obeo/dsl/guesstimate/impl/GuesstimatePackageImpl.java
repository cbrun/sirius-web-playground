...
public class GuesstimatePackageImpl extends EPackageImpl implements GuesstimatePackage {
	...
	public static GuesstimatePackage init() {
		if (isInited)
			return (GuesstimatePackage) EPackage.Registry.INSTANCE.getEPackage(GuesstimatePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredGuesstimatePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		GuesstimatePackageImpl theGuesstimatePackage = registeredGuesstimatePackage instanceof GuesstimatePackageImpl
				? (GuesstimatePackageImpl) registeredGuesstimatePackage
				: new GuesstimatePackageImpl();
		...
		EValidator.Registry.INSTANCE.put(theGuesstimatePackage, new EValidator.Descriptor() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVariable_Definition(), ecorePackage.getEString(), "definition", null, 0, 1, Variable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariable_Type(), this.getVariableType(), "type", "normal", 0, 1, Variable.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVariable_Distribution(), this.getDistributionSetting(), null, "distribution", null, 0, 1,
				Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(distributionSettingEClass, DistributionSetting.class, "DistributionSetting", IS_ABSTRACT,
				IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(normalDistributionEClass, NormalDistribution.class, "NormalDistribution", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNormalDistribution_Mean(), ecorePackage.getEDouble(), "mean", null, 0, 1,
				NormalDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getNormalDistribution_Sd(), ecorePackage.getEDouble(), "sd", "1", 0, 1, NormalDistribution.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(logNormalDistributionEClass, LogNormalDistribution.class, "LogNormalDistribution", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLogNormalDistribution_Scale(), ecorePackage.getEDouble(), "scale", "1", 0, 1,
				LogNormalDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLogNormalDistribution_Shape(), ecorePackage.getEDouble(), "shape", "0", 0, 1,
				LogNormalDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(uniformDistributionEClass, UniformDistribution.class, "UniformDistribution", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUniformDistribution_Min(), ecorePackage.getEDouble(), "min", null, 0, 1,
				UniformDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUniformDistribution_Max(), ecorePackage.getEDouble(), "max", "1", 0, 1,
				UniformDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(betaDistributionEClass, BetaDistribution.class, "BetaDistribution", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBetaDistribution_Alpha(), ecorePackage.getEDouble(), "alpha", "2", 0, 1,
				BetaDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBetaDistribution_Beta(), ecorePackage.getEDouble(), "beta", "2", 0, 1, BetaDistribution.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(triangularDistributionEClass, TriangularDistribution.class, "TriangularDistribution", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTriangularDistribution_Min(), ecorePackage.getEDouble(), "min", "0", 0, 1,
				TriangularDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTriangularDistribution_Max(), ecorePackage.getEDouble(), "max", "1", 0, 1,
				TriangularDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTriangularDistribution_Mode(), ecorePackage.getEDouble(), "mode", "0.5", 0, 1,
				TriangularDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(binomialDistributionEClass, BinomialDistribution.class, "BinomialDistribution", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBinomialDistribution_Trials(), ecorePackage.getEInt(), "trials", "10", 0, 1,
				BinomialDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBinomialDistribution_P(), this.getPercentage(), "p", "0.5", 0, 1, BinomialDistribution.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(formulaSettingEClass, FormulaSetting.class, "FormulaSetting", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFormulaSetting_Formula(), ecorePackage.getEString(), "formula", null, 1, 1,
				FormulaSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getFormulaSetting_Inputs(), this.getVariable(), null, "inputs", null, 0, -1,
				FormulaSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSheet_Variables(), this.getVariable(), null, "variables", null, 0, -1, Sheet.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSheet_SampleSize(), ecorePackage.getEInt(), "sampleSize", "10000", 0, 1, Sheet.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getSheet__Resample(), null, "resample", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(poissonDistributionEClass, PoissonDistribution.class, "PoissonDistribution", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPoissonDistribution_P(), ecorePackage.getEDouble(), "p", "1", 0, 1, PoissonDistribution.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPoissonDistribution_Epsilon(), ecorePackage.getEDouble(), "epsilon", null, 0, 1,
				PoissonDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(exponentialDistributionEClass, ExponentialDistribution.class, "ExponentialDistribution",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExponentialDistribution_Mean(), ecorePackage.getEDouble(), "mean", "1", 0, 1,
		...
		initEClass(gammaDistributionEClass, GammaDistribution.class, "GammaDistribution", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGammaDistribution_Shape(), ecorePackage.getEDouble(), "shape", "2", 0, 1,
				GammaDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getGammaDistribution_Scale(), ecorePackage.getEDouble(), "scale", "1", 0, 1,
				GammaDistribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(variableEClass, source, new String[] { "constraints", "settingsAreValid nameIsValid" });
		addAnnotation(uniformDistributionEClass, source, new String[] { "constraints", "minMaxAreConsistent" });
		addAnnotation(formulaSettingEClass, source, new String[] { "constraints", "unknownVariable invalidSyntax" });
	}
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation(getVariable_Name(), source, new String[] { "documentation",
				"The variable name. Must respect the rules of a programming language identifier." });
		addAnnotation(getVariable_Documentation(), source,
				new String[] { "documentation", "Any human readable description." });
		addAnnotation(getVariable_Definition(), source, new String[] { "documentation",
				"A shortcut in natural language to set the distribution kind and its parameters." });
		addAnnotation(normalDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(getNormalDistribution_Mean(), source, new String[] { "documentation",
		...
		addAnnotation(getNormalDistribution_Sd(), source, new String[] { "documentation",
		...
		addAnnotation(logNormalDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(getLogNormalDistribution_Scale(), source, new String[] { "documentation",
		...
		addAnnotation(getLogNormalDistribution_Shape(), source, new String[] { "documentation",
		...
		addAnnotation(uniformDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(getUniformDistribution_Min(), source, new String[] { "documentation",
		...
		addAnnotation(getUniformDistribution_Max(), source, new String[] { "documentation",
		...
		addAnnotation(betaDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(getBetaDistribution_Alpha(), source, new String[] { "documentation",
		...
		addAnnotation(getBetaDistribution_Beta(), source, new String[] { "documentation",
		...
		addAnnotation(triangularDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(getTriangularDistribution_Min(), source, new String[] { "documentation",
		...
		addAnnotation(getTriangularDistribution_Max(), source, new String[] { "documentation",
		...
		addAnnotation(getTriangularDistribution_Mode(), source, new String[] { "documentation",
		...
		addAnnotation(binomialDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(getBinomialDistribution_Trials(), source, new String[] { "documentation",
		...
		addAnnotation(getBinomialDistribution_P(), source, new String[] { "documentation",
		...
		addAnnotation(formulaSettingEClass, source,
				new String[] { "documentation", "A variable which is defined by a formula using other variables." });
		addAnnotation(poissonDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(exponentialDistributionEClass, source, new String[] { "documentation",
		...
		addAnnotation(gammaDistributionEClass, source, new String[] { "documentation",
